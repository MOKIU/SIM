...
// permisson.js文件通常用于权限管理的相关逻辑,负责定义和控制用户在应用程序中的访问权限
...
function myFilterAsyncRoutes(menuList){
  menuList.filter(menu => {
    // 如果component字段为“Layout”
    if(menu.component === 'Layout'){
      menu.component = Layout // 将Layout对象赋给component使其能够被vue识别
      console.log(menu.component);
    }else{
      menu.component = require(`@/views/${menu.component}.vue`).default // 拼接获取组件
    }
    // 递归处理子菜单
